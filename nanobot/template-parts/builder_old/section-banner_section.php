...
if($args):
	...
	<section class="promo-header">
		...
		<?php if (get_field('is_breadcrumbs')): ?>
			<div class="promo-header__breadcrumbs container">
				<ul class="breadcrumbs"><?php if(function_exists('bcn_display')) bcn_display(); ?></ul>
			</div>
		<?php endif ?>

		<?php if ($title): ?>
			<h1 class="promo-header__title container" data-text="medical animation studio"><?= $title ?></h1>
		<?php endif ?>

		<?php if ($button): ?>
			<div class="promo-header__btn-wrap container">
